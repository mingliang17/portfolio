...
const ProjectMH1 = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="mh1-section-container"
        style={{
      ...
      >
        ...
        <section className="mh1-section mh1-bg-accent">
          <div className="mh1-content-wrapper">
            <h2 className={`text-5xl font-bold text-center mb-20 ${currentSection >= 2 ? 'mh1-fade-in-up' : 'opacity-0'}`}>
              Impact By Numbers
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div 
                  key={i}
                  className={`text-center p-8 bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl hover:scale-105 transition-transform duration-300 ${currentSection >= 2 ? 'mh1-scale-in' : 'opacity-0'}`}
        ...
        <section className="mh1-section">
          <div className="mh1-content-wrapper">
            <div className="mh1-grid-2col">
              <div className={currentSection >= 3 ? 'mh1-slide-in-left' : 'opacity-0'}>
                <h2 className="text-5xl font-bold mb-6 text-yellow-400">
              ...
              <div className={`relative h-96 ${currentSection >= 3 ? 'mh1-slide-in-right' : 'opacity-0'}`}>
